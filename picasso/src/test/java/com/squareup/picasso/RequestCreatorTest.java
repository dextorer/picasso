...
public class RequestCreatorTest {
    ...
    @Test
    public void invalidResize() throws Exception {
        try {
    ...
    @Test
    public void invalidCenterCrop() throws Exception {
        try {
    ...
    @Test
    public void invalidCenterInside() throws Exception {
        try {
            new RequestCreator().resize(10, 10).centerInside().centerCrop();
    ...
    @Test
    public void invalidPlaceholderImage() throws Exception {
        try {
    ...
    @Test
    public void invalidErrorImage() throws Exception {
        try {
    ...
    @Test
    public void nullTargetsInvalid() throws Exception {
        try {

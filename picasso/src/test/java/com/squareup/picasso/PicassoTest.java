...
public class PicassoTest {
    ...
    @Test
    public void completeInvokesErrorOnAllFailedRequests() throws Exception {
        Action action1 = mockAction(URI_KEY_1, URI_1, mockImageViewTarget());
        Action action2 = mockCanceledAction();
    ...
    @Test
    public void completeSkipsIfNoActions() throws Exception {
        BitmapHunter hunter = mockHunter(URI_KEY_1, BITMAP_1, false);
    ...
    @Test
    public void cancelExistingRequestWithUnknownTarget() throws Exception {
    ...
    @Test
    public void cancelExistingRequestWithImageViewTarget() throws Exception {
        ImageView target = mockImageViewTarget();
        Action action = mockAction(URI_KEY_1, URI_1, target);
        picasso.enqueueAndSubmit(action);
        assertThat(picasso.targetToAction).hasSize(1);
    ...
    @Test
    public void cancelExistingRequestWithDeferredImageViewTarget() throws Exception {
        ImageView target = mockImageViewTarget();
    ...
    @Test
    public void cancelExistingRequestWithTarget() throws Exception {
    ...
    @Test
    public void deferAddsToMap() throws Exception {
        ImageView target = mockImageViewTarget();
        DeferredRequestCreator deferredRequestCreator = mockDeferredRequestCreator();
        assertThat(picasso.targetToDeferredRequestCreator).isEmpty();
    ...
    @Test
    public void shutdownTwice() throws Exception {
        picasso.shutdown();
        picasso.shutdown();
        verify(cache).clear();
        verify(stats).shutdown();
    ...
    @Test
    public void shutdownDisallowedOnSingletonInstance() throws Exception {
        try {
    ...
    @Test
    public void shutdownClearsDeferredRequests() throws Exception {
        DeferredRequestCreator deferredRequestCreator = mockDeferredRequestCreator();
        ImageView target = mockImageViewTarget();
        picasso.targetToDeferredRequestCreator.put(target, deferredRequestCreator);
        picasso.shutdown();
    ...
    @Test
    public void whenTransformRequestReturnsNullThrows() throws Exception {
        try {
    ...
    @Test
    public void debuggingChangesFlag() throws Exception {
    ...
    @Test
    public void loadThrowsWithInvalidInput() throws Exception {
        try {
            picasso.load("");
    ...
    @Test
    public void builderInvalidListener() throws Exception {
        try {
    ...
    @Test
    public void builderInvalidLoader() throws Exception {
        try {
    ...
    @Test
    public void builderInvalidExecutor() throws Exception {
        try {
    ...
    @Test
    public void builderInvalidCache() throws Exception {
        try {
    ...
    @Test
    public void builderInvalidRequestTransformer() throws Exception {
        try {
    ...
    @Test
    public void builderWithDebugging() throws Exception {

...
public class BitmapHunterTest {
    ...
    @Test
    public void attachRequest() throws Exception {
    ...
    @Test
    public void detachRequest() throws Exception {
        Action action = mockAction(URI_KEY_1, URI_1, mockImageViewTarget());
        BitmapHunter hunter = new TestableBitmapHunter(picasso, dispatcher, cache, stats, action);
        assertThat(hunter.actions).hasSize(1);
    ...
    @Test
    public void forContentProviderRequest() throws Exception {
    ...
    @Test
    public void forMediaStoreRequest() throws Exception {
    ...
    @Test
    public void forContactsPhotoRequest() throws Exception {
    ...
    @Test
    public void forNetworkRequest() throws Exception {
        Action action = mockAction(URI_KEY_1, URI_1);
        BitmapHunter hunter =
                forRequest(context, picasso, dispatcher, cache, stats, action, downloader);
    ...
    @Test
    public void forFileWithAuthorityRequest() throws Exception {
    ...
    @Test
    public void forAndroidResourceRequest() throws Exception {
    ...
    @Test
    public void forAndroidResourceUriWithId() throws Exception {
    ...
    @Test
    public void forAndroidResourceUriWithType() throws Exception {
    ...
    @Test
    public void exifRotation() throws Exception {
    ...
    @Test
    public void exifRotationWithManualRotation() throws Exception {
        Bitmap source = Bitmap.createBitmap(10, 10, ARGB_8888);
        Request data = new Request.Builder(URI_1).rotate(-45).build();
    ...
    @Test
    public void pivotRotation() throws Exception {
        Bitmap source = Bitmap.createBitmap(10, 10, ARGB_8888);
    ...
    @Test
    public void bitmapConfig() throws Exception {
    ...
    @Test
    public void centerCropTallTooSmall() throws Exception {
    ...
    @Test
    public void centerCropTallTooLarge() throws Exception {
    ...
    @Test
    public void centerCropWideTooSmall() throws Exception {
    ...
    @Test
    public void centerCropWideTooLarge() throws Exception {
    ...
    @Test
    public void centerInsideTallTooSmall() throws Exception {
        Bitmap source = Bitmap.createBitmap(20, 10, ARGB_8888);
    ...
    @Test
    public void centerInsideTallTooLarge() throws Exception {
    ...
    @Test
    public void centerInsideWideTooSmall() throws Exception {
        Bitmap source = Bitmap.createBitmap(10, 20, ARGB_8888);
        Request data = new Request.Builder(URI_1).resize(50, 50).centerInside().build();
    ...
    @Test
    public void centerInsideWideTooLarge() throws Exception {
    ...
    @Test
    public void reusedBitmapIsNotRecycled() throws Exception {

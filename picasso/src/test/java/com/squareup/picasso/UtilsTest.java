...
public class UtilsTest {
    ...
    @Test
    public void matchingRequestsHaveSameKey() throws Exception {
    ...
    @Test
    public void loadedFromCache() throws Exception {
    ...
    @Test
    public void detectedWebPFile() throws Exception {
    ...
    @Test
    public void ensureBuilderIsCleared() throws Exception {
    ...
    @Test
    public void getResourceByTypeAndName() throws IOException {

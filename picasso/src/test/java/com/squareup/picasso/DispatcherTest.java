...
public class DispatcherTest {
    ...
    @Test
    public void shutdownUnregistersReceiver() throws Exception {
        dispatcher.shutdown();
        verify(context).unregisterReceiver(dispatcher.receiver);
    }

    @Test
    public void performSubmitWithNewRequestQueuesHunter() throws Exception {
    ...
    @Test
    public void performSubmitWithTwoDifferentRequestsQueuesHunters() throws Exception {
    ...
    @Test
    public void performSubmitWithExistingRequestAttachesToHunter() throws Exception {
        Action action1 = TestUtils.mockAction(URI_KEY_1, URI_1);
    ...
    @Test
    public void performSubmitWithShutdownServiceIgnoresRequest() throws Exception {
    ...
    @Test
    public void performSubmitWithShutdownAttachesRequest() throws Exception {
    ...
    @Test
    public void performCancelDetachesRequestAndCleansMap() throws Exception {
        Action action = TestUtils.mockAction(URI_KEY_1, URI_1);
        BitmapHunter hunter = mockHunter(URI_KEY_1, BITMAP_1, false);
    ...
    @Test
    public void performCancelMultipleRequestsDetachesOnly() throws Exception {
        Action action1 = TestUtils.mockAction(URI_KEY_1, URI_1);
        Action action2 = TestUtils.mockAction(URI_KEY_1, URI_1);
        BitmapHunter hunter = mockHunter(URI_KEY_1, BITMAP_1, false);
    ...
    @Test
    public void performCompleteSetsResultInCache() throws Exception {
        BitmapHunter hunter = mockHunter(URI_KEY_1, BITMAP_1, false);
    ...
    @Test
    public void performCompleteWithSkipCacheDoesNotCache() throws Exception {
    ...
    @Test
    public void performCompleteCleansUpAndAddsToBatch() throws Exception {
        BitmapHunter hunter = mockHunter(URI_KEY_1, BITMAP_1, false);
        dispatcher.performComplete(hunter);
        assertThat(dispatcher.hunterMap).isEmpty();
    ...
    @Test
    public void performCompleteCleansUpAndDoesNotAddToBatchIfCancelled() throws Exception {
        BitmapHunter hunter = mockHunter(URI_KEY_1, BITMAP_1, false);
    ...
    @Test
    public void performErrorCleansUpAndAddsToBatch() throws Exception {
        BitmapHunter hunter = mockHunter(URI_KEY_1, BITMAP_1, false);
    ...
    @Test
    public void performErrorCleansUpAndDoesNotAddToBatchIfCancelled() throws Exception {
        BitmapHunter hunter = mockHunter(URI_KEY_1, BITMAP_1, false);
        when(hunter.isCancelled()).thenReturn(true);
        dispatcher.hunterMap.put(hunter.getKey(), hunter);
        dispatcher.performError(hunter);
    ...
    @Test
    public void performBatchCompleteFlushesHunters() throws Exception {
    ...
    @Test
    public void performRetrySkipsRetryIfCancelled() throws Exception {
        BitmapHunter hunter = mockHunter(URI_KEY_1, BITMAP_1, false);
        when(hunter.isCancelled()).thenReturn(true);
    ...
    @Test
    public void performRetrySkipsIfHunterSaysNo() throws Exception {
        BitmapHunter hunter = mockHunter(URI_KEY_1, BITMAP_1, false);
    ...
    @Test
    public void performRetrySubmitsToServiceIfHunterSaysYes() throws Exception {
        BitmapHunter hunter = mockHunter(URI_KEY_1, BITMAP_1, false);
    ...
    @Test
    public void performRetrySkipsRetryIfServiceShutdown() throws Exception {
        when(service.isShutdown()).thenReturn(true);
        BitmapHunter hunter = mockHunter(URI_KEY_1, BITMAP_1, false);
        dispatcher.performRetry(hunter);
    ...
    @Test
    public void performAirplaneModeChange() throws Exception {
    ...
    @Test
    public void performNetworkStateChangeWithNullInfoIgnores() throws Exception {
